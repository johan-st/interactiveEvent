...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{inv: _List_Nil, str: 'Hello World', user: '[model.user]'},
		$author$project$Main$getBook);
};
...
var $author$project$Main$Solna = {$: 'Solna'};
var $author$project$Main$items = _List_fromArray(
	[
		{compName: 'NET006W10', labeled: false, office: $author$project$Main$Solna, sent: false},
		{compName: 'NET007W10', labeled: false, office: $author$project$Main$Solna, sent: false}
	]);
var $author$project$Main$officeToText = function (office) {
	switch (office.$) {
		case 'Karhlsruhe':
			return 'Karhlsruhe';
		case 'Dublin':
...
var $author$project$Main$itemsTable = A2(
		...
		]),
	{
		columns: _List_fromArray(
			[
				{
				header: $mdgriffith$elm_ui$Element$text('Computer Name'),
				view: function (item) {
					return $mdgriffith$elm_ui$Element$text(item.compName);
				},
				width: $mdgriffith$elm_ui$Element$fill
			},
				{
				header: $mdgriffith$elm_ui$Element$text('Office'),
				view: function (item) {
					return $mdgriffith$elm_ui$Element$text(
						$author$project$Main$officeToText(item.office));
				},
				width: $mdgriffith$elm_ui$Element$fill
			}
			]),
		data: $author$project$Main$items
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 150, 200, 200)),
				$mdgriffith$elm_ui$Element$explain(
				_Debug_todo(
					'Main',
					{
						start: {line: 97, column: 31},
						end: {line: 97, column: 41}
					}))
			]),
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$author$project$Main$itemsTable]))
				])));
};
